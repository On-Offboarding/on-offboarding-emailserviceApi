        ...
        public static string GenerateHtml(string firstName,string lastName,string personalNumber,string department,string company,string jobTitle,string mobileNumber,DateTime startDate, DateTime employmentDate,List<string> selectedSystems,string requestedBy,string adminPortalUrl,Guid? caseId = null)
        {
            ...
            <body style='margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f4f4;'>
                <div style='max-width: 700px; margin: 20px auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);'>
                    ...
                    <!-- Header -->
                    <div style='background-color: #ff4444; padding: 30px; text-align: center;'>
                        <h1 style='margin: 0; color: #ffffff; font-size: 28px; font-weight: 600;'>
                            Ny Offboarding Begäran
                        </h1>
                        <p style='margin: 10px 0 0 0; color: #e0e7ff; font-size: 16px;'>
                           En chef har begärt offboarding för personal
                        </p>
                    </div>
                    ...
                    <div style='padding: 30px;'>
                        ...
                        <p style='font-size: 16px; color: #333; line-height: 1.6; margin-bottom: 25px;'>
                            Hej CTO,<br><br>
                             En ny offboarding-begäran har skapats i systemet. Nedan hittar du information om personen och de systemåtkomster som behöver återkallas.                        </p>
                        ...
                        <div style='text-align: center; margin: 30px 0;'>
                            <a href='{adminPortalUrl}' 
                                style='display: inline-block; background-color: #ff4444; color: #ffffff; text-decoration: none; padding: 14px 30px; border-radius: 6px; font-size: 16px; font-weight: 600; box-shadow: 0 4px 6px rgba(102, 126, 234, 0.3);'>
                                 Öppna Adminportalen
                            </a>
                        </div>
                    </div>
